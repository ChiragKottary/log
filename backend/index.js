...
const URL = "mongodb+srv://amulyad24:ammu123456@cluster0.y8bsmzz.mongodb.net/student?retryWrites=true&w=majority&appName=Cluster0";
...
app.post("/login", (req, res)=> {
    ...
    stdModel.findOne({ name: name}, (err, user) => {
        if(user){
